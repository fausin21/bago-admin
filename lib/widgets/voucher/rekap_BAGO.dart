...
class RekapBagoVoucher extends StatefulWidget {
  final String? cabang;

  RekapBagoVoucher({this.cabang});

  @override
  _RekapBagoVoucherState createState() => _RekapBagoVoucherState();
}

class _RekapBagoVoucherState extends State<RekapBagoVoucher>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Rekap Voucher ${widget.cabang?.toUpperCase() ?? ''}',
          style: TextStyle(
                ...
                Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        totalAmount > 0 ? 'Lunas' : 'Belum Bayar',
                        style: TextStyle(
                          fontSize: 10,
                          color: totalAmount > 0
                              ? Colors.green[600]
