...
class LsAdminVoucherSentul extends StatefulWidget {
  final String? cabang;

  LsAdminVoucherSentul({this.cabang});

  @override
  _LsAdminVoucherSentulState createState() => _LsAdminVoucherSentulState();
}

class _LsAdminVoucherSentulState extends State<LsAdminVoucherSentul>
  ...
  Future<List<dynamic>> fetchRekapData() async {
    final response = await http.get(
      Uri.parse(
          'http://aplikasi.bago.web.id/api/admin/tagihan_voucher_ls_admin.php?cabang=sentul'),
    );
