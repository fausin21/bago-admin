...
class rekap_plaosan extends StatefulWidget {
  @override
  _rekap_plaosanState createState() => _rekap_plaosanState();
}

class _rekap_plaosanState extends State<rekap_plaosan> {
  List<dynamic> rekapData = [];
  String cabang = 'plaosan';
  int totalTagihan = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Rekap Lunas Plaosan'),
        actions: [
          ElevatedButton(
            onPressed:
