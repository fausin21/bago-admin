...
class rekap_ranon extends StatefulWidget {
  @override
  _rekap_ranonState createState() => _rekap_ranonState();
}

class _rekap_ranonState extends State<rekap_ranon> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Rekap Lunas ranon'),
        actions: [
          ElevatedButton(
            onPressed:
