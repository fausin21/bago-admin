...
class rekap_mandati extends StatefulWidget {
  @override
  _rekap_mandatiState createState() => _rekap_mandatiState();
}

class _rekap_mandatiState extends State<rekap_mandati> {
  List<dynamic> rekapData = [];
  String cabang = 'mandati';
  int totalTagihan = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Rekap Lunas Mandati'),
        actions: [
          ElevatedButton(
            onPressed:
