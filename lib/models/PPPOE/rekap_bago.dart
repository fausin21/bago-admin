...
class RekapBago extends StatefulWidget {
  @override
  _RekapBagoState createState() => _RekapBagoState();
}

class _RekapBagoState extends State<RekapBago> with TickerProviderStateMixin {
  ...
  Future<void> fetchData() async {
    try {
      final response = await http.get(
        Uri.parse(
            'http://aplikasi.bago.web.id/api/bago/bago_baru/pppoe_lunas.php?id=1'),
      );
          ...
          IconButton(
            ...
            onPressed: () async {
              final q = await showSearch<String?>(
                context: context,
                delegate: RekapBagoSearchDelegate(rekapData),
              );
...
class RekapBagoSearchDelegate extends SearchDelegate<String?> {
  final List<dynamic> data;
  List<String> recent = [];

  RekapBagoSearchDelegate(this.data);
